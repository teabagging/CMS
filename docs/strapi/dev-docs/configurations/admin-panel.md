...
| `auditLogs.retentionDays`         | How long [Audit Logs](/user-docs/settings/audit-logs) are kept, in days._The behavior differs for self-hosted vs. Strapi Cloud customers, see the note under the table._               | integer       | 90                                                                                                                                  |
...
| `transfer.token.salt`             | Salt used to generate [Transfer tokens](/dev-docs/data-management/transfer#generate-a-transfer-token).If no transfer token salt is defined, transfer features will be disabled.               | string        | Random string                                                                                                                       |
...
minimal config" label="Minimal configuration">
...
full config" label="Full configuration">
