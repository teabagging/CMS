...
description: Configure rendering of markup to HTML.
 ...
 [markup,markdown,goldmark,asciidoc,asciidoctor,highlighting]
...
[content format]: //formats/#formats
...
[mathematics in Markdown]: /mathematics/
...
[multilingual page resources]: //page-resources/#multilingual
...
This is the default `highlight` configuration. Note that some of these settings can be set per code block, see [Syntax Highlighting](//syntax-highlighting/).
...
For CSS, see [Generate Syntax Highlighter CSS](//syntax-highlighting/#generate-syntax-highlighter-css).
