...
To resolve, uninstall the standard edition, then install the extended edition. See the  section for details.
...
A directory with an index.md file is a [leaf bundle]. A directory with an _index.md file is a [branch bundle]. See&nbsp;[details](//page-bundles/).
...
`{{</* shortcode */>}}` notation. See&nbsp;[details](//shortcodes/).
